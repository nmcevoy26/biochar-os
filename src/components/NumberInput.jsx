export default function NumberInput({ label, value, onChange, unit, step = 1, min, max, placeholder, error = false, warn = false }) {
      ...
      <div className="flex items-center gap-2">
        ...
        <div className="relative flex-1">
          <input
            ...
            className={`input-field text-center pr-12 ${error ? '!border-red-400 !border-2' : warn ? '!border-amber-400 !border-2' : ''}`}
            min={min}
            max={max}
            step={step}
          />
